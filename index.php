...
<html lang="zxx">
   ...
   <body>
    ...
    <table align="center" border=1px topmargin="10"style="width:600px; line-height:40px;">
     
     <form action="load.php" method="POST">
     <input type="text" name="reg" placeholder="registration">
     <input type="text" name="marks" placeholder="marks">
     <input type="text" name="nam" placeholder="name">
     <input type="submit" name="submit" value="submit">
     <br>
                      <a href="resultform.php">Result</a>
                      <br><br><br><br><br>   <a href="main.php">Contents of data base</a>
